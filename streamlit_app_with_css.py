...
all_idc.pop(count_interactions)
all_pregunta.pop(count_interactions)
all_resposta.pop(count_interactions)
all_data.pop(count_interactions)
all_curso.pop(count_interactions)
