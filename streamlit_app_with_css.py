...
all_idc.pop(count_interactions-1)
all_pregunta.pop(count_interactions-1)
all_resposta.pop(count_interactions-1)
all_data.pop(count_interactions-1)
all_curso.pop(count_interactions-1)
